...
/* Use LwIP-provided errno definitions to ensure ENOMEM etc. are available */
#define LWIP_PROVIDE_ERRNO 1
#define LWIP_SO_RCVTIMEO 1

/* Priority settings for CMSIS-RTOS V2 / FreeRTOS */
/* osPriorityHigh = 40, osPriorityAboveNormal = 32, osPriorityNormal = 24 */
